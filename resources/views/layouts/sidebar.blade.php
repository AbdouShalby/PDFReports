    ...
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="scroll-sidebar" style="overflow: hidden; width: auto; height: 100%;">
            ...
            <nav class="sidebar-nav active">
                <ul class="in">
                    ...
                    <li class="{{ $title == 'all-sick-leaves' ? 'active' : '' }}"> <a href="{{ route('all-sick-leaves') }}"><i class="fa fa-th-large"></i><span class="hide-menu">{{ __('sidebar.all-sick-leaves') }}</span></a></li>
                    ...
                    <li class="{{ $title == 'all-sick-leaves-fahd' ? 'active' : '' }}"> <a href="{{ route('all-sick-leaves-fahd') }}"><i class="fa fa-th-large"></i><span class="hide-menu">{{ __('sidebar.all-sick-leaves-fahd') }}</span></a></li>
                    ...
                    <li class="{{ $title == 'all-review-scenes' ? 'active' : '' }}"> <a href="{{ route('all-review-scenes') }}"><i class="fa fa-th-large"></i><span class="hide-menu">{{ __('sidebar.all-review-scenes') }}</span></a></li>
