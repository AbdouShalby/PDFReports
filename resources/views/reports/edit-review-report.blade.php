                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="review_date" class="form-control @error('review_date') is-invalid @enderror" value="{{ $report->review_date }}" type="date" required placeholder="{{ __('review-report.review-date') }}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="physician_name" class="form-control @error('physician_name') is-invalid @enderror" type="text" placeholder="{{ __('review-report.physician-name') }}">
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('review-report.physician-position') }}</label>
                                            <input name="physician_position" class="form-control @error('physician_position') is-invalid @enderror" type="text" placeholder="{{ __('review-report.physician-position') }}">
                                        </div>
                                        <div class="form-group">
