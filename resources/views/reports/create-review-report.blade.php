                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="name_en" class="form-control @error('name_en') is-invalid @enderror" value="{{ old('name_en') }}" type="text"  placeholder="{{ __('review-report.name-en') }}">
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('review-report.name-ar') }}</label>
                                            <input name="name_ar" class="form-control @error('name_ar') is-invalid @enderror" value="{{ old('name_ar') }}" type="text"  placeholder="{{ __('review-report.name-ar') }}">
                                        </div>
                                        <div class="form-group">
